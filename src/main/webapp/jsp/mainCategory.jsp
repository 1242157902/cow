...
<body>
    ...
    <%--	<ul class="toolbar">
        ...
        <form action="${pageContext.request.contextPath}/getCategoryList.do">

            <ul class="toolbar">

                <li> <label>品种名称：</label>  <input name="categoryname" type="text" class="scinput1" />　</li> 　　　　
   ...
   <%--     <ul class="toolbar1">
    ...
    <table class="tablelist">
        ...
        <th>品种编号<i class="sort"><img src="images/px.gif" /></i></th>
        <th>品种名称</th>
        <th>品种状态</th>
        <th>品种描述</th>
        <th>操作</th>
        ...
        <tbody>
        <c:forEach items="${pageInfo.list}" var="cowCategory">
            <tr>
            <td><input name="" type="checkbox" value="" /></td>
            <td>${cowCategory.id}</td>
            <td>${cowCategory.categoryname}</td>
            <td>
            ...
            <td>${cowCategory.description}</td>
            <td><a href="${pageContext.request.contextPath}/jsp/addCategory.jsp" class="tablelink">新增</a>   <a href="${pageContext.request.contextPath}/updateCategory.do?cowCategoryId=${cowCategory.id}" class="tablelink">修改</a>  <%--<a href="${pageContext.request.contextPath}/deletecowCategory.do?id=${cowCategory.id}" class="tablelink">删除</a>--%></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
